...
# Ubuntu 26 initial release - 2026-04-30

> **BREAKING**
> - New base image: **Ubuntu 26.04 LTS** (codename `resolute`).
> - Default PHP version bumped from 8.3 to **8.5**.
> - The `:latest` Docker Hub tag now points at this u26 build (PHP 8.5).
> - Legacy Ubuntu 24.04 builds remain available under the `u24*` tag prefix
>   (see the `u24/` directory in the repository).
...
## Pre-u26 history (Ubuntu 24.04 line, see `u24/CHANGELOG.md` for the full log)
